...
class VideoService:
    ...
    def draw_actor(self, actor, center=False, right=False):
        ...
        if right:
            width = pyray.measure_text(text, font_size)
            x = (constants.MAX_X - width - constants.CELL_SIZE)
        pyray.draw_text(text, x, y, font_size, color)
        
    def draw_actors(self, actors, center=False, right=False):
        ...
        """ 
        for actor in actors:
            self.draw_actor(actor, center, right)
