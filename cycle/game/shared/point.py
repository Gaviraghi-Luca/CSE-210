...
class Point:
    ...
    def too_close(self, other):
        ...
        Returns: 
            boolean: True if both dist_x and dist_y are less than CELL_SIZE; false if otherwise.
        """
        dist_x = abs(self._x - other.get_x())
        dist_y = abs(self._y - other.get_y())
        return (dist_x <= constants.CELL_SIZE and dist_y <= constants.CELL_SIZE)
