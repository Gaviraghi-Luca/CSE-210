...
class VideoService:
    ...
    def draw_sprite(self, sprite):
        """Draws the given sprite's text on the screen.

        Args:
            sprite (sprite): The sprite to draw.
        """ 
        text = sprite.get_text()
        x = sprite.get_position().get_x()
        y = sprite.get_position().get_y()
        font_size = sprite.get_font_size()
        color = sprite.get_color().to_tuple()
        pyray.draw_text(text, x, y, font_size, color)
        
    def draw_sprites(self, sprites):
        """Draws the text for the given list of sprites on the screen.

        Args:
            sprites (list): A list of sprites to draw.
        """ 
